...
public class NetworkDO implements Serializable {
	...
	@Builder.Default // Ensures that the initialization is respected even with the builder
	@JsonIgnore
	private List<NetworkDetailsDO> simulatedData = new ArrayList<>(); // initialization
