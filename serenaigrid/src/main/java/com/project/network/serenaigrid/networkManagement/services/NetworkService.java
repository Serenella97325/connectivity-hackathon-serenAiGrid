...
public class NetworkService {
	...
	public ApiResponse<Network> registerNetwork(Network network) {
		try {
			if (network == null) {
	...
	public ApiResponse<List<Network>> getAllNetworks() {
		try {
	...
	public ApiResponse<Network> getNetworkById(String networkId) {
		try {
